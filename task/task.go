...
// Clear removes all tasks marked as done from the store.
// It returns the number of cleared tasks, the number of remaining tasks, and
// any error encountered. On error, no changes are written to disk.

...
// It returns the number of tasks cleared, the number of tasks remaining,
// and any I/O error encountered during load or save.
// If there are no completed tasks, cleared will be 0 and the method succeeds.
